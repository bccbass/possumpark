...
const Section = ({ section, children }) => {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
      className={` px-8  flex flex-col items-center w-screen self-center md:mt-16 md:px-20 lg:px-0 ${
        section.menuTitle == "contact" ? "max-w-xl" : "max-w-4xl"
      }`}
    >
      <div className="w-full max-w-3xl border flex flex-col items-center mt-4  overflow-hidden bg-neutral-50 p-8">
